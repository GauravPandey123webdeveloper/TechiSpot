      ...
      <MDBContainer className="py-5 h-100">
        ...
        <MDBRow className="justify-content-center align-items-center h-100">
          <MDBCol lg="" xl="">
            <MDBCard>
              <div
                className={`rounded-top text-white d-flex flex-row ${styles["rounded-top"]}`}
              >
                <div
                  className={`ms-4 mt-5 d-flex flex-column ${styles["ms-4"]}`}
                >
                  <MDBCardImage
                    src={postdata[id].userProfile.userImage}
                    alt="Generic placeholder image"
                    className={`mt-4 mb-2 img-thumbnail ${styles["img-thumbnail"]}`}
                    fluid
                  />
                  <MDBBtn

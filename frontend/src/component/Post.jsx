    ...
    <div className={styles.post}>
      ...
      <div className={styles.userpost}>
        <div className={styles.profileContainer}>
          ...
          <div className={styles.followAlign}>
            <div><img src="https://i.pinimg.com/474x/bd/26/b7/bd26b704fca0c5e3fe68f10322bf65c0.jpg" alt="Profile" className={styles.profilePic} /> TechiSpot  </div>
            <div><button className={`${styles.followButton} ${isFollowing ? styles.whenclick1 : ''}`} onClick={handleFollowToggle}> {isFollowing ? 'Following' : 'Follow +'}
            </button></div>
            </div>
